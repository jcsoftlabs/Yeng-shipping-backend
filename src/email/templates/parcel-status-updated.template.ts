...
export function getParcelStatusUpdatedEmailTemplate(data: {
    customerName: string;
    ...
    const oldStatusLabel = getStatusLabel(data.oldStatus);
    const newStatusLabel = getStatusLabel(data.newStatus);
